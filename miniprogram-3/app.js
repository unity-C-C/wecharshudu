     ...
     if(this.gamedata.qiujie.length<=0){
      ...
      //随机赋值
       ...
       break;
        ...
        nums =nandu+5;
        var nums0=100;
        var jjiujiuscopy1 = JSON.parse(JSON.stringify(jiujius));
        while(true){
          this.gamedata.qiujie=[];
          var rand =  parseInt(Math.random()*jjiujiuscopy1.length);

          var jjiujiuscopy = JSON.parse(JSON.stringify(jiujius));
          jjiujiuscopy[jjiujiuscopy1[rand].id].date="";
          ...
          if(this.gamedata.qiujie.length<=0){
            ...
            jiujius[jjiujiuscopy1[rand].id].date="";
            jjiujiuscopy1.splice(jjiujiuscopy1[jjiujiuscopy1[rand].id],1);
            nums--;
          }
